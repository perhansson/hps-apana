...
c***************************************************************
      ...
      subroutine solvtl(pl1,pl2,pb1,pb2,metx,mety,mt,mw,mb,pn1,pn2,n)
      implicit none
      ...
      real*8 x1,y1,z1,x2,y2,z2,q1,q2,q3,q4,q5,q6,q7,q8,q9,q10,q11
      real*8 k4(5)
      complex*16 r4(4)
      integer i
...
c      b2=-(pl1(2)+pl2(2)+pb1(2)+pb2(2))
     ...
     &     q5*q8*q11+q5*q9*q10
      ...
      n=0
      do i=1,4
c         if (abs(dimag(r4(i)))/abs(r4(i)).lt.0.001d0) then
         if (abs(dimag(r4(i))).lt.1.d-3) then
            n=n+1
            x1=dble(r4(i))
            ...
            pn1(2,n)=y1
            pn1(3,n)=z1
            pn1(4,n)=sqrt(x1*x1+y1*y1+z1*z1)
            pn2(1,n)=x2
            pn2(2,n)=y2
            pn2(3,n)=z2
            pn2(4,n)=sqrt(x2*x2+y2*y2+z2*z2)

            q1=aa1*x1*x1+bb1*x1*y1+cc1*y1*y1+dd1+u1*x1+v1*y1
            q2=aa2*y1*y1+bb2*x1*y1+cc2*x1*x1+dd2+u2*y1+v2*x1

c            print *,'diff q1,q2=',q1,q2
